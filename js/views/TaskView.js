          ...
          <div draggable="true" class="task" data-id="${this.task.id}">
            ...
            <button class="task__delete" aria-label="Delete task">
                <svg version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 200" class="task__delete-icon">
                  ...
                  z"/>
                  <path d="M138.332,73.598h-76c-1.1,0-2-0.9-2-2s0.9-2,2-2h76c1.1,0,2,0.9,2,2S139.432,73.598,138.332,73.598z"/>
                  <path d="M138.332,85.598h-76c-1.1,0-2-0.9-2-2s0.9-2,2-2h76c1.1,0,2,0.9,2,2S139.432,85.598,138.332,85.598z"/>
                  <path d="M112.332,73.698h-24c-1.1,0-2-0.9-2-2v-6c0-6.6,5.4-12,12-12h4c6.6,0,12,5.4,12,12v6
